 ...
 */
    ...
    public:
        ...
        virtual Status nset(const std::string &name, int64_t number, std::string &value) = 0;
        virtual Status nset(const std::string &name, int64_t number, std::string &value, int ttl) = 0;
        virtual Status nget(const std::string &name, int64_t number, std::string *value) = 0;
        virtual Status ndel(const std::string &name, int64_t number) = 0;
        virtual Status nexists(const std::string &name, int64_t number) = 0;
//	virtual Status nmset(const std::string &name, const std::vector<int64_t, std::string> &elements) = 0;
//	virtual Status nmdel(const std::string &name, const std::vector<int64_t> &numbers) = 0;
//	virtual Status nrange(const std::string &name, int64_t offset, int64_t limit, std::vector<std::string> *values) = 0;
//	virtual Status nrrange(const std::string &name, int64_t offset, int64_t limit, std::vector<std::string> *values) = 0;
//	virtual Status nscan(const std::string &name, int64_t nstart, int64_t nend, int64_t offset, int64_t limit, std::vector<int64_t, std::string> *elements) = 0;
//	virtual Status nrscan(const std::string &name, int64_t nstart, int64_t nend, int64_t offset, int64_t limit, std::vector<int64_t, std::string> *elements) = 0;
//	virtual Status nsize(const std::string &name, int64_t *size) = 0;
//	virtual Status nclear(const std::string &name) = 0;
//	virtual Status nsum(const std::string &name, int64_t nstart, int64_t nend, int64_t *ret) = 0;
//	virtual Status nava(const std::string &name, int64_t nstart, int64_t nend, int64_t *ret) = 0;
//	virtual Status nremrangebyscore(const std::string &name, int64_t nstart, int64_t nend) = 0;
//	virtual Status nremrangebyrank(const std::string &name, int64_t nstart, int64_t nend) = 0;
//	virtual Status npop_front(const std::string &name, int64_t limit, std::vector<std::string> *values) = 0;
//	virtual Status npop_back(const std::string &name, int64_t limit, std::vector<std::string> *values) = 0;
//	virtual Status nexpire(const std::string &name, int64_t ttl) = 0;
//	virtual Status nttl(const std::string &name, int64_t *ret) = 0;
//	virtual Status ns_expire(const std::string &name, int64_t number, int64_t ttl) = 0;
//	virtual Status ns_ttl(const std::string &name,int64_t number, int64_t *ret) = 0;
    private:
        // No copying allowed
        Client(const Client&);
