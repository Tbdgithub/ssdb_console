...
static RedisCommand_raw cmds_raw[] = {
        ...
        /* add the following command for liebao */
        {STRATEGY_AUTO, "setnxex",	"setnxex",		REPLY_INT},
        {STRATEGY_AUTO, "increx",	"increx",		REPLY_INT},
        ...
        {STRATEGY_AUTO,		"nset",			"nset",				REPLY_STATUS},
        {STRATEGY_AUTO,		"nget",			"nget",				REPLY_BULK},
        {STRATEGY_AUTO,		"ndel",			"ndel",				REPLY_INT},
        {STRATEGY_AUTO,		"nexists",		"nexists",			REPLY_INT},
        {STRATEGY_AUTO,		"ncset",		"ncset",			REPLY_STATUS},
        {STRATEGY_AUTO,		"ncget",		"ncget",			REPLY_BULK},
        {STRATEGY_AUTO,		"ncdel",		"ncdel",			REPLY_INT},
        {STRATEGY_AUTO,		"ncexists",		"ncexists",			REPLY_INT},
        {STRATEGY_AUTO,		"nmset",		"nmset",			REPLY_STATUS},
        {STRATEGY_AUTO,		"nmdel",		"nmdel",			REPLY_INT},
        {STRATEGY_AUTO,		"nrange",		"nrange",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nrrange",		"nrrange",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nscan",		"nscan",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nrscan",		"nrscan",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nsize",		"nsize",			REPLY_INT},
        {STRATEGY_AUTO,		"nclear",		"nclear",			REPLY_INT},
        {STRATEGY_AUTO,		"nsum",			"nsum",				REPLY_INT},
        {STRATEGY_AUTO,		"navg",			"navg",				REPLY_INT},
        {STRATEGY_AUTO,		"nremrangebyscore",		"nremrangebyscore",			REPLY_INT},
        {STRATEGY_AUTO,		"nremrangebyrank",		"nremrangebyrank",			REPLY_INT},
        {STRATEGY_AUTO,		"npop_front",	"npop_front",		REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"npop_back",	"npop_back",		REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nlist",		"nlist",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nrlist",		"nrlist",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"nexpire",		"nexpire",			REPLY_INT},
        {STRATEGY_AUTO,		"nttl",			"nttl",				REPLY_INT},
        {STRATEGY_AUTO,		"ncmset",		"ncmset",			REPLY_INT},
        {STRATEGY_AUTO,		"ncmget",		"ncmget",			REPLY_MULTI_BULK},
        {STRATEGY_AUTO,		"ncscan",		"ncscan",			REPLY_ROW_COLUMN_TABLE},
        {STRATEGY_AUTO,		"ncrscan",		"ncrscan",			REPLY_ROW_COLUMN_TABLE},
...
int RedisLink::send_resp(Buffer *output, const std::vector<std::string> &resp){
    ...
    if (req_desc->reply_type == REPLY_ROW_COLUMN_TABLE) {
        if(resp.size() % 2 != 1) {
            output->append("*0");
            return 0;
        }
        ...
        for (; resp_it != resp.end(); resp_it++) {
            char val_len_buf[32];
            std::string val = *resp_it;
            snprintf(val_len_buf, sizeof(val_len_buf), "$%d\r\n", (int)val.size());
            output->append(val_len_buf);
            output->append(val.c_str(), val.size());
            output->append("\r\n");
        }
        return 0;
    }
