...
#ifndef SSDB_CONSOLE__SSDB_IMPL_H
#define SSDB_CONSOLE__SSDB_IMPL_H
...
namespace ssdb{
    ...
    public:
        ...
        virtual Status nlist(const std::string &key_start, const std::string &key_end,
                            uint64_t limit, std::vector<std::string> *ret);
        ...
        virtual Status nset(const std::string &name, int64_t number, std::string &value);
        virtual Status nset(const std::string &name, int64_t number, std::string &value, int ttl);
        virtual Status nget(const std::string &name, int64_t number, std::string *value);
        virtual Status ndel(const std::string &name, int64_t number);
        virtual Status nexists(const std::string &name, int64_t number);
//	virtual Status nmset(const std::string &name, const std::vector<int64_t, std::string> &elements);
//	virtual Status nmdel(const std::string &name, const std::vector<int64_t> &numbers);
//	virtual Status nrange(const std::string &name, int64_t offset, int64_t limit, std::vector<std::string> *values);
//	virtual Status nrrange(const std::string &name, int64_t offset, int64_t limit, std::vector<std::string> *values);
//	virtual Status nscan(const std::string &name, int64_t nstart, int64_t nend, int64_t offset, int64_t limit, std::vector<int64_t, std::string> *elements);
//	virtual Status nrscan(const std::string &name, int64_t nstart, int64_t nend, int64_t offset, int64_t limit, std::vector<int64_t, std::string> *elements);
//	virtual Status nsize(const std::string &name, int64_t *size);
//	virtual Status nclear(const std::string &name);
//	virtual Status nsum(const std::string &name, int64_t nstart, int64_t nend, int64_t *ret);
//	virtual Status nava(const std::string &name, int64_t nstart, int64_t nend, int64_t *ret);
//	virtual Status nremrangebyscore(const std::string &name, int64_t nstart, int64_t nend);
//	virtual Status nremrangebyrank(const std::string &name, int64_t nstart, int64_t nend);
//	virtual Status npop_front(const std::string &name, int64_t limit, std::vector<std::string> *values);
//	virtual Status npop_back(const std::string &name, int64_t limit, std::vector<std::string> *values);
//	virtual Status nexpire(const std::string &name, int64_t ttl);
//	virtual Status nttl(const std::string &name, int64_t *ret);
//	virtual Status ns_expire(const std::string &name, int64_t number, int64_t ttl);
//	virtual Status ns_ttl(const std::string &name,int64_t number, int64_t *ret);

    };

}; // namespace ssdb

#endif //CPP1_SSDB_IMPL_H
